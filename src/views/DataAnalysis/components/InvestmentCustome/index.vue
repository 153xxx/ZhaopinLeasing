...
<script setup>
  import { ref } from 'vue';
  import Chart from '/@/views/DataAnalysis/components/InvestmentCustome/InvestmentChart.vue';
  import Dataset from '/@/views/DataAnalysis/components/InvestmentCustome/InvestmentDataset.vue';
